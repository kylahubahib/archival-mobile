...
export default function Approved(sectionId, taskId) {
  ...
  const getManuscript = async () => {
    ...
    try {
      ...
      const response = await axios.get('/my-approved-manuscripts', {
    ...
    <Card style={styles.card}>
      <Card.Content>
        ...
        <View style={styles.infoRow}>
          ...
          { item.man_doc_status === 'A' && <Text style={[styles.statusApproved]}> Approved </Text> }
          { item.man_doc_status === 'P' && <Text style={[styles.statusPending]}> Pending </Text> }
          { item.man_doc_status === 'D' && <Text style={[styles.statusPending]}> Unpublished </Text> }
        </View>
      </Card.Content>
    </Card>
  );
